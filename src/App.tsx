...
export default function App() {
  ...
  const handleCreateArticleSubmit = async (e?: React.FormEvent, forceCreate: boolean = false) => {
    ...
    // Dynamic nextSkuCode generated or custom SKU typed by the user
    const chosenSku = newArticle.codigo.trim() || getNextAvailableSku();
    ...
    try {
      ...
      setNewArticleStep(1);
      setIsCreateModalOpen(false); // Close the modal inside the catalog page to provide beautiful response feedback
      refreshSystemData();
      if (output.item) {
          ...
          <div className="bg-white rounded-2xl max-w-3xl w-full p-6 border border-slate-200 shadow-2xl relative my-8 text-xs font-medium text-slate-700">
            ...
            {creationType === 'simple' && (
              ...
              >
                ...
                {/* Step 1: Info Básica */}
                <div className={newArticleStep === 1 ? "space-y-4 animate-fade-in" : "hidden"}>
                    <div className="grid grid-cols-1 md:grid-cols-6 gap-3.5 items-end">
                      ...
                      <div className="space-y-1.5 md:col-span-2">
                        <div className="flex items-center justify-between">
                          ...
                          <span className="text-[9px] font-extrabold bg-indigo-50 text-indigo-600 px-1.5 py-0.5 rounded border border-indigo-200 uppercase tracking-wider">Editable</span>
                        </div>
                        <input
                          type="text"
                          required
                          value={newArticle.codigo}
                          onChange={(e) => setNewArticle(prev => ({ ...prev, codigo: e.target.value }))}
                          placeholder="Ej: J111"
                          title="Escribe un SKU único o modifica el generado automáticamente"
                          className="w-full bg-white border border-slate-200 rounded-xl px-3 py-2 text-xs font-mono font-bold text-indigo-600 focus:ring-2 focus:ring-indigo-500 focus:outline-none"
                        />
                      </div>
...
• Confección artesanal y cuidada."
                ...
                {/* Step 2: Precios */}
                <div className={newArticleStep === 2 ? "space-y-4 animate-fade-in" : "hidden"}>
                ...
                {(() => {
                  ...
                  return (
                    <div className={newArticleStep === 3 ? "space-y-4 animate-fade-in font-sans" : "hidden"}>
                ...
                <div className={newArticleStep === 4 ? "space-y-4 animate-fade-in font-sans" : "hidden"}>
                          ...
                          <div className="grid grid-cols-2 md:grid-cols-6 gap-2 items-end bg-white p-3 rounded-xl border border-slate-200">
                            ...
                            <div className="space-y-1">
                              <div className="flex justify-between items-center">
                                ...
                                <span className="text-[8px] text-indigo-500 font-bold uppercase">Editable</span>
                              </div>
                              <input
                                type="text"
                                value={varSku}
